mascostas = ['Ares', 'Max', 'Pulga', 'Furilais', 'Pluto', 'Wolfgang']

mascostas.insert(1, 'Zeus') # Agrega en la lista en la posicion que le diga
mascostas.append('Hades') # Agrega en la ultima posicion
